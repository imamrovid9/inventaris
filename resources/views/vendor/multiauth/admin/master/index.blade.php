                                ...
                                <h3 class="card-title"><!-- Button trigger modal -->
                                    ...
                                    <div class="modal-dialog" role="document">
                                        ...
                                        <div class="modal-body">
                                            <form action="{{ route('admin.createmasterskpd') }}" enctype="multipart/form-data" class="text-capitalize" method="post">
                                                @csrf
                                                ...
                                                <div class="form-group">
                                                    <label>Telepon :</label>
                                                    <input type="number" name="telepon" value="" placeholder="021xxxxxx" class="form-control" required>
                                                </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="#" onclick="confirm1Tag({{ $listskpd->id }})" class=" text-danger"><i class="fa fa-trash"></i></a>
                                                        <form id="confirm1-form-{{ $listskpd->id }}" action="{{ url('admin/master/delete/skpd',[$listskpd->id]) }}" method="POST" style="display: none;">
                                                            {{ csrf_field() }}
                                                        </form>
                                            </td>
                                        </tr>
