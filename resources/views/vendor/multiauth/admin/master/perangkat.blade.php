                                ...
                                <h3 class="card-title"><!-- Button trigger modal -->
                                    ...
                                    <div class="modal-dialog" role="document">
                                        ...
                                        <div class="modal-body">
                                            <form action="{{ route('admin.createmasterperangkat') }}" enctype="multipart/form-data" class="text-capitalize" method="post">
                                                @csrf
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="#" onclick="confirm1Tag({{ $listperangkat->id }})" class=" text-danger"><i class="fa fa-trash"></i></a>
                                                        <form id="confirm1-form-{{ $listperangkat->id }}" action="{{ url('admin/master/delete/perangkat',[$listperangkat->id]) }}" method="POST" style="display: none;">
                                                            {{ csrf_field() }}
                                                        </form>
                                            </td>
                                        </tr>
